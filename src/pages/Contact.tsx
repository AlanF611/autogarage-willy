...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Construir mensaje con los datos del formulario
    const serviceMap: Record<string, string> = {
      ceramico: 'Detallado Cerámico',
      ppf: 'PPF & Restauraciones',
      tapiceria: 'Tapicería Premium',
      pintura: 'Pintura & Repros Tuning',
      escaneos: 'Escaneos 3D',
    ...
    const serviceLabel = form.service ? serviceMap[form.service] || form.service : 'No especificado';
    
    const message = `*NUEVA CONSULTA - DETALLADOS PREMIUM*
...
---
Este mensaje fue enviado desde el formulario de contacto de Detallados Premium.`;
              ...
              {submitted ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-6 text-gold font-body text-sm hover:underline"
                  >
