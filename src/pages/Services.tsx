...
const services: Service[] = [
  ...
  // 8. Diseño y Fabricación CNC
  {
    ...
    image: '/img/CNC/1.jpeg',
    gallery: generateGallery('CNC', 4),
    duration: '7-14 días',
    warranty: '2 años',
    details: [
  ...
  // 11. Alarmas y GPS
  {
    ...
    image: '/img/GPS Y DETALLADO/2.jpeg',
  ...
  // 12. Repros Tuning
  {
    ...
    image: '/img/repro tunning/1.jpeg',
    gallery: generateGallery('repro tunning', 3),
    duration: '2-5 días',
    warranty: '1 año',
    details: [
